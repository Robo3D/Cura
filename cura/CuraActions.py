...
class CuraActions(QObject):
    ...
    def openDocumentation(self):
        ...
        event = CallFunctionEvent(self._openUrl, [QUrl("https://help.robo3d.com/hc/en-us/categories/115000094472-Cura-for-Robo-Desktop")], {})
        Application.getInstance().functionEvent(event)

    @pyqtSlot()
    def openBugReportPage(self):
        event = CallFunctionEvent(self._openUrl, [QUrl("http://github.com/Robo3D/Cura/issues")], {})
        Application.getInstance().functionEvent(event)
